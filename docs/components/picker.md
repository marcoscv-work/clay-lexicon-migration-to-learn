...
| `tabIndex` | `number` | `0` | No | Sets the tabindex of the trigger to control its position in the tab order, for example when the picker takes part in roving tabindex navigation. |
